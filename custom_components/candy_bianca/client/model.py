...
class WashingMachineStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            zoom_state=json["Opt9"] == "1",
            pre_wash=json["Opt1"] == "1",
            hygiene_wash=json["Opt2"] == "1",
            anti_crease=json["Opt3"] == "1",
            night_spin=json["Opt4"] == "1",
            extra_water=json["Opt8"] == "1",
            rinse_1=json["Opt5"] == "1",
            rinse_2=json["Opt6"] == "1",
            rinse_3=json["Opt7"] == "1",
            slevel=int(json["SLevel"]),
            error_wash=int(json["Err"])
        )
