...
class CandyWashingMachineSensor(CandyBaseSensor):
    ...
    def extra_state_attributes(self) -> Mapping[str, Any]:
        ...
        attributes = {
            ...
            "del_val": status.del_val,
            "zoom": status.zoom_state,
            "pre_wash": status.pre_wash, 
            "hygiene_wash": status.hygiene_wash,
            "anti_crease": status.anti_crease,
            "night_spin": status.night_spin,
            "extra_water": status.extra_water,
            "rinse_1": status.rinse_1,
            "rinse_2": status.rinse_2,
            "rinse_3": status.rinse_3,
            "slevel": status.slevel,
            "error": status.error_wash,
